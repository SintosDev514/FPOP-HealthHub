        ...
        <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "13px" }}>
          ...
          <tbody>
            {filteredUsers.length > 0 ? (
                ...
                <tr key={user.id} style={{ borderBottom: "1px solid rgba(30,58,95,0.04)", transition: "background 0.2s" }} onMouseEnter={e => e.currentTarget.style.background = "#f8fafc"} onMouseLeave={e => e.currentTarget.style.background = "transparent"}>
                  ...
                  <td style={{ padding: "14px 24px" }}>
                    <span style={{ 
                      ...
                      fontSize: "11px", 
                      fontWeight: 600,
                      background: user.role === "Admin" ? "rgba(124,58,237,0.1)" : user.role === "Staff" ? "rgba(59,130,246,0.1)" : "rgba(107,114,128,0.1)",
                      color: user.role === "Admin" ? PURPLE : user.role === "Staff" ? "#3b82f6" : "#6b7280"
                    }}>
                      {user.role}
                    </span>
                  </td>
                  ...
                  <td style={{ padding: "14px 24px", textAlign: "right" }}>
                    <div style={{ display: "flex", gap: "10px", justifyContent: "flex-end" }}>
                      ...
                      <button 
                        ...
                        style={{ background: "transparent", border: "none", color: user.status === "Active" ? "#ea580c" : GREEN, cursor: "pointer", padding: "4px", display: "flex", alignItems: "center" }}
                      >
                        {user.status === "Active" ? (
                      ...
                      <button 
                        ...
                        title="Delete" 
                        style={{ background: "transparent", border: "none", color: RED, cursor: "pointer", padding: "4px", display: "flex", alignItems: "center" }}
                      >
              ...
              <tr>
                <td colSpan="6" style={{ padding: "30px", textCenter: "center", color: "#8a96a3", textAlign: "center" }}>No users match the criteria.</td>
              </tr>
            )}
          </tbody>
        </table>
