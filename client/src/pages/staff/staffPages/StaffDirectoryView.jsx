        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[950px] border-collapse text-left">
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={4} className="px-5 py-8 text-center text-sm text-[#8a96a3]">Loading...</td>
                </tr>
              ) : staffList.length === 0 ? (
                <tr>
                  <td colSpan={4} className="px-5 py-8 text-center text-sm text-[#8a96a3]">No staff found</td>
                </tr>
              ) : (
