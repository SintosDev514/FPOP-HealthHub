    ...
    const ctx = gsap.context(() => {
      ...
      const typeTargets = [
        { el: titleRef.current, text: "Our Location" },
        {
          ...
          text: "Visit our clinic at the address below:",
        },
        ...
        <div className="overflow-hidden rounded-[35px] bg-white shadow-[0_16px_40px_rgba(30,58,95,0.10)]">
          ...
          >
            ...
            <div className="relative grid items-center gap-4 lg:grid-cols-[1.05fr_0.95fr] lg:gap-8 ">
              ...
              <div
                ref={heroTextRef}
                className="text-white text-center lg:text-left px-18"
              >
                <h1
                  ref={titleRef}
          ...
          <section className="px-5 py-6 sm:px-7 md:px-10 lg:px-12 lg:py-8">
            ...
            >
              ...
              <div className="h-[280px] w-full sm:h-[340px] md:h-[420px] lg:h-[500px]">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!4v1779781462779!6m8!1m7!1sAQ_YDzWCeoVV2LP1OCXiNw!2m2!1d12.06586115753468!2d124.5984800572697!3f46.07961774540992!4f-10.404312416959627!5f0.7820865974627469"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
